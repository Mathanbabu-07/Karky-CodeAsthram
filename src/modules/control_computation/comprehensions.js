...
Blockly.defineBlocksWithJsonArray([
  {
    ...
    "message0": "list comprehension [ %1 for %2 in %3 where %4 ]",
    "args0": [
      {
        "type": "input_value",
        "name": "EXPR"
  ...
  },
  {
    ...
    "message0": "dict comprehension { %1 : %2 for %3, %4 in zip( %5 , %6 ) where %7 }",
    "args0": [
  ...
  },
  {
    ...
    "message0": "dictionary comprehension { %1 : %2 for %3 in %4 where %5 }",
    "args0": [
      {
        "type": "input_value",
        "name": "KEY_EXPR"
  ...
  },
  {
    ...
    "message0": "set comprehension { %1 for %2 in %3 where %4 }",
    "args0": [
      {
        "type": "input_value",
        "name": "EXPR"
  ...
  },
  {
    ...
    "message0": "generator expression ( %1 for %2 in %3 where %4 )",
    "args0": [
      {
        "type": "input_value",
        "name": "EXPR"
...
const DictZipCompMutator = {
  ...
  updateShape_: function (hasCond) {
    ...
    if (hasCond) {
      if (!condInput) {
        this.appendValueInput('COND').setCheck('Boolean').appendField('where');
      }
    } else if (condInput) {
