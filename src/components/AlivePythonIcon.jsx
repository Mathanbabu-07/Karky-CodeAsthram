// src/components/AlivePythonIcon.jsx
import React from 'react';
import '../AlivePythonIcon.css';

export default function AlivePythonIcon() {
  return (
    <div className="alive-python-icon">
      <svg
      ...
      >
        ...
        <defs>
          <linearGradient id="paint0_linear_87_8204" x1="12.4809" y1="2" x2="12.4809" y2="22.7407" gradientUnits="userSpaceOnUse">
            <stop style={{ stopColor: 'var(--primary-500)' }} />
            <stop offset="1" style={{ stopColor: 'var(--primary-600)' }} />
          </linearGradient>
          <linearGradient id="paint1_linear_87_8204" x1="19.519" y1="9.25928" x2="19.519" y2="30" gradientUnits="userSpaceOnUse">
            <stop style={{ stopColor: 'var(--accent-500)' }} />
            <stop offset="1" style={{ stopColor: 'var(--accent-600)' }} />
          </linearGradient>
        </defs>
      </svg>
    </div>
